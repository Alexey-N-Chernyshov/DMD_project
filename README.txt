...
The command available both in Windows and Linux:
psql -U username -f 'infile' database_name

2. execute this query to add auth table to any database:
...
2. run src/dbms/psqlloader.py to create a datafile for your dbms and import data from Postgres
